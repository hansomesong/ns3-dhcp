...
main (int argc, char *argv[])
{
  ...
  ipv4Router1->AddAddress (ifIndex, Ipv4InterfaceAddress (Ipv4Address ("172.30.0.17"), Ipv4Mask ("/0"))); // need to remove this workaround
  ...
  DhcpServerHelper dhcp_server (Ipv4Address ("172.30.0.0"), Ipv4Mask ("/24"), Ipv4Address ("172.30.0.17"), Ipv4Address ("172.30.0.10"), Ipv4Address ("172.30.0.15"), Ipv4Address ("172.30.0.17"));
  ApplicationContainer ap_dhcp_server = dhcp_server.Install (Router.Get (1));
  ...
  ApplicationContainer clientApps = echoClient.Install (MN.Get (1));

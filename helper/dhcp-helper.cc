...
DhcpServerHelper::DhcpServerHelper (Ipv4Address pool_addr, Ipv4Mask pool_mask, Ipv4Address serv_addr, Ipv4Address min_addr, Ipv4Address max_addr, Ipv4Address gateway)
{
